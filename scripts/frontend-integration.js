 ...
 * This file demonstrates how to integrate Gemmaembed with a web frontend
 */

// For React/Vue/Angular applications
export class GemmaembedClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GemmaembedClient(provider, contractAddress);
